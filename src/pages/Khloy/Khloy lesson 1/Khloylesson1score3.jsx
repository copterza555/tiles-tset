...
export default function Khloylesson2score3() {
  return (
    <Background>
      <div style={styles.page}>
        ...
        <div style={styles.lessonContainer}>
          <p style={styles.lessonText}>คุณผ่านแบบทดสอบประวัติความเป็นมา</p>
        </div>

        
        <div>
            <img src={Iconpass} alt="ล็อค 1" style={styles.lockIcon1} />
            <img src={Iconpass} alt="ล็อค 2" style={styles.lockIcon2} />
        ...
        <div style={styles.buttonContainer}>
          <Link to="/Chapterkhloy2" style={styles.startButton}>
            ไปหน้าต่อไป
          </Link>
        </div>
