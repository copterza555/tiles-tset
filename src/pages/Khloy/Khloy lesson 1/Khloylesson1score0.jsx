...
export default function Khloylesson1score0() {
  return (
    <Background>
      <div style={styles.page}>
        ...
        <div style={styles.lessonContainer}>
          <p style={styles.lessonText}>คุณไม่ผ่านแบบทดสอบประวัติความเป็นมา</p>
        </div>
        ...
        <div>
            ...
            <img src={unlockIcon} alt="ล็อค 3" style={styles.lockIcon3} />
        </div>
